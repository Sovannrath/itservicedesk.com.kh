...
return [
    ...
    */
    ...
    'api_key'    => function_exists('env') ? env('NEXMO_KEY', '24ffec67') : '',
    'api_secret' => function_exists('env') ? env('NEXMO_SECRET', 'eTKOiOmvc9X1uKYL') : '',
    ...
    */
    ...
    'signature_secret' => function_exists('env') ? env('NEXMO_SIGNATURE_SECRET', 'Myxq83gO2QrxqsuMXz8BuLAzqkq4DZMjQ2zuYLDghxfcRTiPj3') : '',
