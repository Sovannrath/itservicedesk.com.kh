@foreach(App\Employee::all() as $value)
<div class="" id="Emp_Details" title="Employee Detail" style="margin-bottom:20px">
	@php
	...
	<div class="col-sm-4">
		<dl class="dl-horizontal">
			...
			@if($business->BusinessUnitID == $value->BusinessUnitID)
			<dd><em>{{$business->Description}}</em></dd>
			@endif
			@endforeach
