...
<div class="widget-body" id="emp_detail">
        @foreach($data as $value)
            ...
            <div class="col-sm-4">
                <a href="#" data-toggle="modal" data-target="#remoteModal" title="New Incident" class="btn icon-btn btn-lg btn-warning pull-right" style="font-size: 12px"><span class="glyphicon btn-glyphicon glyphicon-trash img-circle" style="color:#FF9800"></span>Delete</a>
                <a class="btn icon-btn btn-lg btn-warning pull-right" style="font-size: 12px" href="/employees/edit/{{$value->EmployeeID}}"><span class="glyphicon btn-glyphicon glyphicon-pencil img-circle" style="color:#FF9800"></span>Edit</a>
